	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.student_has_many_registerEntry}">
				<li class="fieldcontain">
					<span id="student_has_many_registerEntry-label" class="property-label"><g:message code="student.student_has_many_registerEntry.label" default="Studenthasmanyregister Entry" /></span>
					
						<g:each in="${studentInstance.student_has_many_registerEntry}" var="s">
						<span class="property-value" aria-labelledby="student_has_many_registerEntry-label"><g:link controller="registerEntry" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
