			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="regClass.class_course.label" default="Classcourse" /></th>
				...
				<g:each in="${regClassInstanceList}" status="i" var="regClassInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${regClassInstance.id}">${fieldValue(bean: regClassInstance, field: "class_course")}</g:link></td>
					
						<td>${fieldValue(bean: regClassInstance, field: "class_instructor")}</td>
